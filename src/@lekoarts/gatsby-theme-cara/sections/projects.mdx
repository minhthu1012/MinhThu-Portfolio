...
<ProjectCard
  title="KPMG Data Analysis Virtual Internship"
  link="[https://www.lekoarts.de/gatsby/tips-and-tricks-for-gatsby?utm_source=cara&utm_medium=Theme](https://github.com/minhthu1012/KPMG-Virtual-Internship-DataAnalytics-Consulting)"
  bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
>
  A wonderful exposure based on a real case study. During this experience, I have learned how to:
  Explore and find ways to get quality data from datasets using Excel
  Analyze data and develop model to target the most valued customers through a detailed approach
  Create Dashboard to present data insights using Power BI
</ProjectCard>
<ProjectCard
